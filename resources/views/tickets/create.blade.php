            ...
            <div class="col-span-3 sm:col-span-2">
              ...
              <div class="grid grid-cols-4 gap-6">
                  ...
                  <div class="mt-1 flex rounded-md shadow-sm">
                    <input type="text" name="username" id="user_id" class="focus:ring-indigo-500 focus:border-indigo-500 flex-1 block w-full rounded-none rounded-r-md sm:text-sm border-gray-300" value="自动获取">
                  </div>

                  <label for="manager_id" class="block text-sm font-medium text-gray-700">主管姓名</label>
                  <select id="manager_id" name="manager_id" class="mt-1 block w-full pl-3 pr-10 py-2 text-base border-gray-300 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm rounded-md">
                      <option>张三</option>
                  ...
                  <select id="location_id" name="location_id" class="mt-1 block w-full pl-3 pr-10 py-2 text-base border-gray-300 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm rounded-md">
